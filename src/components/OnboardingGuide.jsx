...
const STEPS = [
  {
    ...
    subtitle: 'Your Automated Digit Trading Terminal',
    content: 'Derivprinter fires simultaneous double trades on Deriv synthetic indices — executing both sides of a digit prediction (Even & Odd, or Over & Under 5) at the exact same millisecond.',
  ...
  },
  {
    icon: Zap,
    title: 'How It Works',
    subtitle: 'Connect → Configure → Fire',
    content: 'Click "Connect Deriv" in the header to log in via OAuth. Once connected, choose your strategy (Even/Odd or Over/Under 5) and hit START on the Dashboard. The bot will automatically fire paired trades.',
    tip: 'You can switch between Demo and Real accounts from the header dropdown.',
    color: '#00e676',
  },
  {
    icon: Radar,
    title: 'Market Scanner',
    subtitle: 'Find the best market conditions',
    content: 'The Scanner page analyzes all Volatility Index markets in real-time, scoring each one based on digit distribution patterns. Higher scores mean stronger signals for your chosen strategy.',
    tip: 'Tap any market in the Scanner to switch to it instantly.',
    color: '#00a8ff',
  },
  {
    icon: Shield,
